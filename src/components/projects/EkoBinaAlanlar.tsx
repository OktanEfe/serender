        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 mb-8">
          ...
          {areas.map((area, i) => (
            ...
            <button
              ...
              className={`group w-full sm:w-auto min-h-[48px] sm:min-h-[44px] flex items-center justify-start sm:justify-center gap-2 px-4 sm:px-5 py-3 sm:py-2.5 rounded-2xl sm:rounded-full text-[13px] sm:text-[13px] font-medium tracking-wide text-left transition-all duration-300 ${
              ...
              <span
                ...
                className={`text-[10px] font-semibold tracking-wider shrink-0 ${
                  ...
                  activeArea === i
                    ...
                    : "text-[#9C9C94] group-hover:text-[#1E4D3A]/50"
            ...
            <div className="flex items-center gap-4 mt-8 pt-6 border-t border-[#E8E4DC]">
              ...
              <button
                ...
                onClick={() =>
                  ...
                  setActiveArea((prev) => (prev - 1 + areas.length) % areas.length)
