...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#FAF9F6] border-t border-[#E8E4DC]">
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-12 grid grid-cols-2 md:grid-cols-4 gap-10">
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 pb-8 flex flex-col md:flex-row items-center justify-between gap-4">
