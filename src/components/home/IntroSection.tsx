  ...
  return (
    <section className="relative w-full bg-[#FAF9F6] py-24 md:py-40 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#1E4D3A]/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#B7D8A6]/15 rounded-full blur-[100px]" />
      </div>
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <line x1="20" y1="0" x2="20" y2="120" stroke="#1E4D3A" strokeWidth="1.5" />
        <path d="M20 30 C20 30 5 20 2 8 C8 12 20 30 20 30Z" fill="#1E4D3A" />
        <path d="M20 30 C20 30 35 20 38 8 C32 12 20 30 20 30Z" fill="#1E4D3A" />
        <path d="M20 55 C20 55 4 44 0 30 C8 36 20 55 20 55Z" fill="#1E4D3A" />
        <path d="M20 55 C20 55 36 44 40 30 C32 36 20 55 20 55Z" fill="#1E4D3A" />
        <path d="M20 78 C20 78 6 67 3 52 C10 58 20 78 20 78Z" fill="#1E4D3A" />
        <path d="M20 78 C20 78 34 67 37 52 C30 58 20 78 20 78Z" fill="#1E4D3A" />
      </svg>
      ...
      <div className="relative z-10 max-w-[1000px] mx-auto px-6">
        <div className="flex flex-col space-y-12">
          ...
          <div className="flex items-center gap-4">
            <span className="text-[11px] font-medium tracking-[0.25em] text-[#1E4D3A] uppercase">
              Biz Kimiz
            </span>
          ...
          <div>
            <h2 className="text-[#231F20] text-3xl md:text-5xl lg:text-[3.5rem] font-light leading-[1.25] tracking-tight">
              ...
              <span className="text-[#1E4D3A] font-medium">sessiz bir uyumun </span>
              içinde saklıdır.
            </h2>
          </div>
