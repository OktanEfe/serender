        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-16">
            <article>
              ...
              <div className="mt-12 p-6 bg-white border border-[#E8E4DC] rounded-2xl">
                <p className="text-[10px] font-medium tracking-[0.2em] text-[#9C9C94] uppercase mb-3">
                  İlham Kaynağı
                </p>
                <p className="text-[#231F20] text-base font-medium">
                  {post.inspiredBy}
                </p>
              </div>
